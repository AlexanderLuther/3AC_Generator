...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  public int error_sym() {return 1;}
    ...
    LinkedList<Package> pilaPaquetes = new LinkedList<>();
    private Project proyecto = new Project();
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
        ...
        proyecto.setName(id.toString());
        proyecto.getPrincipalPackage().setId(id.toString());
        proyecto.getPrincipalPackage().setName(id.toString());
        ...
        pilaPaquetes.add(proyecto.getPrincipalPackage());
		...
		Object nombre = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
            ...
            pilaPaquetes.getLast().setName(nombre.toString());
		...
		Object nombre = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
            ...
            archivo.setName(nombre.toString());
		...
		Object paquete = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
            ...
            archivo.setPackage_(paquete.toString());
		...
		Object codigo = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
            ...
            archivo.setCode(codigo.toString());
