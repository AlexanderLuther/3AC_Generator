...
package com.hluther.javacompiler.utilidades.proyecto.analisis;

import java_cup.runtime.*;
import com.hluther.javacompiler.utilidades.proyecto.analisis.ParserSym.*;
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 32: break;
          case 3:
            { return new Symbol(ParserSym.ID_NOMBRE, yyline, yycolumn, yytext());
            }
            // fall through
          case 33: break;
          case 4:
            { return new Symbol(ParserSym.ET_ARCHIVO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 34: break;
          case 5:
            { return new Symbol(ParserSym.ET_PAQUETE_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 35: break;
          case 6:
            { return new Symbol(ParserSym.ET_ARCHIVO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 36: break;
          case 7:
            { return new Symbol(ParserSym.ET_PAQUETE_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 37: break;
          case 8:
            { return new Symbol(ParserSym.ET_ID_ARCHIVO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 38: break;
          case 9:
            { return new Symbol(ParserSym.ET_ID_PAQUETE_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 39: break;
          case 10:
            { return new Symbol(ParserSym.ET_PROYECTO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 40: break;
          case 11:
            { return new Symbol(ParserSym.ET_ID_ARCHIVO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 41: break;
          case 12:
            { return new Symbol(ParserSym.ET_ID_PAQUETE_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 42: break;
          case 13:
            { return new Symbol(ParserSym.ET_PROYECTO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 43: break;
          case 14:
            { return new Symbol(ParserSym.ET_CODIGO_ARCHIVO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 44: break;
          case 15:
            { return new Symbol(ParserSym.ET_NOMBRE_ARCHIVO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 45: break;
          case 16:
            { return new Symbol(ParserSym.ET_NOMBRE_PAQUETE_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 46: break;
          case 17:
            { return new Symbol(ParserSym.ET_CODIGO_ARCHIVO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 47: break;
          case 18:
            { return new Symbol(ParserSym.ET_NOMBRE_ARCHIVO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 48: break;
          case 19:
            { return new Symbol(ParserSym.ET_NOMBRE_PAQUETE_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 49: break;
          case 20:
            { return new Symbol(ParserSym.ET_NOMBRE_PROYECTO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 50: break;
          case 21:
            { return new Symbol(ParserSym.ET_PAQUETE_ARCHIVO_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 51: break;
          case 22:
            { return new Symbol(ParserSym.ET_NOMBRE_PROYECTO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 52: break;
          case 23:
            { return new Symbol(ParserSym.ET_PAQUETE_ARCHIVO_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 53: break;
          case 24:
            { return new Symbol(ParserSym.ET_ARCHIVOS_PAQUETE_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 54: break;
          case 25:
            { return new Symbol(ParserSym.ET_PAQUETES_PAQUETE_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 55: break;
          case 26:
            { return new Symbol(ParserSym.ET_ARCHIVOS_PAQUETE_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 56: break;
          case 27:
            { return new Symbol(ParserSym.ET_PAQUETES_PAQUETE_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 57: break;
          case 28:
            { return new Symbol(ParserSym.ET_PAQUETE_PRINCIPAL_INIC, yyline, yycolumn, yytext());
            }
            // fall through
          case 58: break;
          case 29:
            { return new Symbol(ParserSym.ET_PAQUETE_PRINCIPAL_FIN, yyline, yycolumn, yytext());
            }
            // fall through
          case 59: break;
          case 30:
            { return new Symbol(ParserSym.CODIGO, yyline, yycolumn, yytext().substring(14,yytext().length()-14));
            }
            // fall through
          case 60: break;
          default:
